...
export function TopBar() {
  ...
  const { theme, toggleTheme, toggleCommandPalette } = useUIStore()
          ...
          <Magnetic>
            <Link href="/dashboard" className="font-semibold tracking-tight text-lg cursor-pointer flex items-center gap-2">
              <div className="w-6 h-6 bg-[var(--color-text-primary)] rounded-full flex items-center justify-center">
                <Heart className="w-3 h-3 text-[var(--color-text-inverse)]" />
              </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={menuRef}>
            <Magnetic>
              ...
              >
                {mounted ? (user?.fullName?.[0]?.toUpperCase() || 'P') : 'P'}
              </button>
            </Magnetic>
              ...
              >
                <div className="px-4 py-3 border-b border-[var(--color-border-subtle)]">
                  <p className="text-sm font-medium text-[var(--color-text-primary)] truncate">
                    {mounted ? (user?.fullName || 'Patient') : 'Patient'}
                  </p>
